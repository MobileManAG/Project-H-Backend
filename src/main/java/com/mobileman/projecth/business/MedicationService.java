...
/**
 * Represents service for the {@link Medication} entity.
 * 
 * @author mobileman
 *
 */
public interface MedicationService extends EntityService<Medication>, SearchService<Medication> {

	/**
	 * @param pzn
	 * @param locale 
	 * @return Medication whose pzn barcode (pharmazentralnummer) is equal to the given pzn
	 * @throws IllegalArgumentException 
	 * <li>pzn == null or pzn is blank</li> 
	 * <li>locale == null</li> 
	 */
	 ...
	 * @param name
	 * @param locale 
	 * @return list of medications whose name starts with given name or empty list
	 * @throws IllegalArgumentException if 
	 * <li>name == null or name is blank</li> 
	 * <li>locale == null</li> 
	 */
