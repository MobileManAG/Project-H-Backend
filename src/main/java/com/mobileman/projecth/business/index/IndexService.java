...
/**
 * Declares operation on all index entities
 * 
 * @author mobileman
 * @param <T>
 * 
 */
public interface IndexService<T extends Index> extends EntityService<T>, SearchService<T> {
	 ...
	 */
	T findByCode(String code) throws IllegalArgumentException;
}
