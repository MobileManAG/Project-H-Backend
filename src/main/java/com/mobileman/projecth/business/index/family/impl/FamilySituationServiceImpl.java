...
package com.mobileman.projecth.business.index.family.impl;
...
public class FamilySituationServiceImpl extends IndexServiceImpl<FamilySituation> implements FamilySituationService {

	/**
	 */
	public FamilySituationServiceImpl() {
		super(FamilySituation.class);
	}
