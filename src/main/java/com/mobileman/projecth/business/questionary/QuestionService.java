 ...
 *
 */
public interface QuestionService extends EntityService<Question>, SearchService<Question> {

	/**
	 * Deletes custom question with data
	 * @param questionId
	 */
	void deleteCustomQuestion(Long questionId);
}
