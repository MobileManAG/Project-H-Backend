...
package com.mobileman.projecth.domain.index.country;
...
@Indexed
public class Country extends Index {
	...
	/**
	 * @return locale of given country
	 */
	@Column(name = "locale", nullable = false, length = 255, unique=true)
